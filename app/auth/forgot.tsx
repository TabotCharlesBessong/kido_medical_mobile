...
const forgot = () => {
  ...
  const handleSubmit = async (values: ForgotValues, actions: FormikHelpers<ForgotValues>) => {
    console.log(values)
    try {
      setLoading(true)
      setErrorMessage('')
      const res = await fetch('http:192.168.1.185:5000/api/user/forgot-password', {
        method: 'POST',
        headers: {
  ...
  return (
    <KeyboardAvoidingView style={styles.container}>
      <CustomText type='h2'>You forgot your password, no problem you can reset it</CustomText>
