...
import { MedicationFrequency, Prescription } from "@/constants/types/prescription";

const MyPatientPrescriptionsScreen = () => {
  const { t } = useTranslation();
  const router = useRouter();
  const dispatch: AppDispatch = useDispatch();
  const { patientPrescriptions, isLoading, error } = useSelector(
  ...
  const handleViewPrescription = (prescription: Prescription) => {
    router.push({
      // @ts-ignore
      pathname: "/my-records/prescription-detail-view",
