...
const ConsultationScreen: React.FC = () => {
  ...
  const consultationSchema = yup.object().shape({
    ...
    pastHistory: yup.string().required(t('consultation.validation.pastHistoryRequired')),
    diagnosticImpression: yup
      .string()
      .required(t('consultation.validation.diagnosticImpressionRequired')),
    investigations: yup.string().required(t('consultation.validation.investigationsRequired')),
    treatment: yup.string().required(t('consultation.validation.treatmentRequired')),
  })
